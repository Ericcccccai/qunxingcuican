export const GAMES = {
  focus: {title:'主角捕获实验', description:'两位主角正在抢镜。光点进入金色区域时按下快门，共拍三张；拍中两次就算稳住场面。', success:'你拍到了两位主角都在焦内的照片。yqc 说自己其实还能更好，zzc 说肩甲不完整。你把相机转给他们：这叫合照，不叫两张单人海报同时开庭。', rough:'三张照片各有各的想法：yqc 的丝带、zzc 的肩甲，以及一张全员失去物理边界的抽象画。两人一致要求重拍，你把它命名为《关系很好，信号不好》。', skip:'你切成自动连拍。相机响了二十声，两个人各自认领了十八张封面。数学在这个天台上暂时没有管辖权。'},
  packing: {title:'客厅领土回收战', description:'选中物品，再点击格子放入箱子。可以旋转。将三件物品全部装进左侧 3 × 4 区域，右侧虚线是客厅通道，不能占。没有倒计时。', success:'箱子居然合上了。zzc 看着恢复通行的客厅，若有所思：“那刚才其实还能再放一件。”你直接坐在箱盖上，宣布本轮招商结束。', rough:'箱子不服，你也不服。最后 zzc 自己把装甲抱在怀里，睡袋绑在箱顶。它们形成一座有身份证的移动山脉。', skip:'你把空箱子推给 zzc：“这是你的副本。”十分钟后，他抱着装甲出来，说箱子空间设计有待优化。你的客厅拒绝承担研发成本。'},
  archive: {title:'返图失忆症', description:'翻开卡片，找出四对相同的返图。不同的两张会在下一次翻牌时盖回。不限时间，七轮内配完可拿到“人类缓存”称号。', success:'四组照片全部找回。zzc 说“我就知道你记得”，手指已经滑向退出。你把下载按钮点亮给他看，他终于当场存了——存到一个叫“新建文件夹（最终）2”的文件夹。', rough:'照片找齐了，你也短暂体验了 zzc 的记忆管理方式。他安慰你：“没事，下次再找。”你决定把这句话设成他的手机锁屏。', skip:'你把相册搜索栏交给 zzc。他输入自己的名字，得到四百八十二个结果。yqc 在旁边点评：“这个数据库只收录一种生物。”'}
};
